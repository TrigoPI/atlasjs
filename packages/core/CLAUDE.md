...
> The scheduling/loop design is documented in **`docs/scheduling-redesign.md`** at the repo root. Read it before changing the scheduler, the loop, or plugin boot.
