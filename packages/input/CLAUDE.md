...
> Design doc at the repo root: **`memory/atlas/gameplay/input-scripting.md`** — the unified input-scripting doc. Phase 1: how scripts reach input (the façade in gameplay sits on this package's service). Phase 2: the named-action system, incl. the V2/out-of-scope section. Read it before touching `public/actions/`.
