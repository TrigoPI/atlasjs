...
Planned (not implemented): material **instance serialization** (`MaterialData` POJO + `materialize`/`dematerialize` with injected resolvers) is intended to live here in the core — see `memory/atlas/rendering/material-graph.md` §3.
