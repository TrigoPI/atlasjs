...
Relevé en câblant le dash du joueur sur `Key.Shift` ([`APP-08`](APP-08-player-dash.md)) : c'est une action de gameplay courante, tenue en même temps que WASD, et un joueur gaucher ou habitué au Shift droit conclura simplement que le dash ne marche pas.
