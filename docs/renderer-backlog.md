...
### A1. Rendu de formes / primitives — *reco n°1, meilleur ratio valeur/effort*
...
### A2. Rendu de texte — *gros mais incontournable en 2D*
...
### B1. Cycle de vie des ressources — *le plus « dette »*
...
### B2. Éditeur désynchronisé de nebula — *à investiguer en premier si l'éditeur compte*
