...
- **Réflexion = autorité du layout** : le passage uniform→storage se fait _via_ la réflexion, pas de calcul d'offset à la main (cf. `docs/rendering/shaders-materials.md`).
