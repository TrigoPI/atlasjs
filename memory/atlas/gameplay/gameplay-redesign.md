...
> **Raffiné depuis :** l'accès aux façades décrit ici (getters magiques `this.transform`/`this.rigidbody`) est remplacé par un accès unifié façon Unity `GetComponent` — voir `memory/atlas/gameplay/scripting-components.md`.
