...
>
> Prérequis de lecture : `memory/atlas/gameplay/scripting-components.md` (les deux niveaux de composants, `AtlasScript`, façades, modèle `GetComponent`, `attach`), `memory/atlas/gameplay/sprite-animation.md` (`Animator`, `SpriteAnimation`), `memory/atlas/rendering/sprites.md` (`Sprite`/`Texture2D`).
...
## 11. Hors périmètre (V2 → `memory/atlas/backlog/`)
