...
Cohérent avec la taxonomie L1/L2 (`memory/atlas/gameplay/scripting-components.md`) et le principe « source unique dans Nexus, backend en aval » (`memory/atlas/gameplay/gameplay-redesign.md`).
