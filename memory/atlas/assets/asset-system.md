...
Le système d'asset actuel est bancal et repose sur une seule tranche minimale posée lors du redesign sprite (`memory/atlas/rendering/sprites.md`) :
...
**Racine**
- `memory/atlas/backlog/` + index docs du `CLAUDE.md` : référencer ce document.
...
- [x] `memory/atlas/backlog/` + index `CLAUDE.md` : référencer ce doc.
