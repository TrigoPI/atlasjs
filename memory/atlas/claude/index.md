...
- [[cpu-particles-feature]] — système de particules CPU sur feat/claude/cpu-particles : moteur fait et testé, jamais affiché ; réutilise le sprite batch donc nebula-webgpu intact ; le goulot est packStorageArray, pas la boucle de sim
