...
- [[bump-royal-online-feature]] — bump-royal en ligne (branche poussée, non mergée) ; un Engine Atlas tourne headless en Node **sans travail moteur** (stub nebula, pas d'input, pas d'audio, surtout pas de caméra) ; ScriptManager désactive en silence un script dont `onCreate` throw
