...
- [[cpu-particles-feature]] — système de particules CPU livré sur feat/claude/cpu-particles (non mergé), vérifié navigateur ; réutilise le sprite batch donc nebula-webgpu intact ; le goulot est packStorageArray, pas la boucle de sim ; un sprite quasi vide en additif ressemble à un pipeline cassé
